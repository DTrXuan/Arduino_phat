...
void setup() {
  ...
  */
  pinMode(bangtai_o,OUTPUT);   // Cấu hình chân output cấp xung điều khiển driver động cơ băng tải
  ...
  */
  pinMode(bom_o,OUTPUT);  // Cấu hình chân output cấp xung điều khiển driver động cơ bơm
  analogWrite(bom_o,0);   // Xuất xung pwm với duty = (0)*0.255%. Duty càng lớn tốc độ càng nhanh. range: 0 -> 255
